...
export default function ClientsPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-secondary font-apple">
      {/* Apple Style Header */}
      <header className="nav-apple bg-white/80 backdrop-blur-xl border-b border-border-light sticky top-0 z-50">
        <div className="container-apple py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-apple-heading text-text-primary">客戶管理中心</h1>
                <p className="text-xs text-text-secondary">管理所有客戶資料、聯絡信息及服務記錄</p>
              </div>
            </div>
      ...
      <main className="container-apple py-6">
        ...
        <div className="card-apple mb-6 fade-in-apple">
          <div className="card-apple-header">
            <h3 className="text-apple-heading text-text-primary">搜尋與篩選</h3>
          </div>
          <div className="card-apple-content">
            {/* Enhanced Search Bar with Suggestions */}
            <div className="mb-6 relative" style={{ zIndex: 10000 }}>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-12 pr-24 py-3 bg-bg-secondary border-transparent focus:bg-white focus:border-mingcare-blue focus:shadow-apple-focus rounded-apple-sm text-sm transition-all duration-200"
                />
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-3 space-x-2">
                  ...
                  <button
                    ...
                    className="btn-apple-primary py-1 px-3 text-xs"
                    type="button"
                  >
                    搜尋
                  </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="form-group-apple">
                <label className="form-label-apple">客戶類型</label>
                <select 
              ...
              <div className="form-group-apple">
                <label className="form-label-apple">地區</label>
                <select 
              ...
              <div className="form-group-apple">
                <label className="form-label-apple">介紹人</label>
                <select 
              ...
              <div className="form-group-apple">
                <label className="form-label-apple">負責同事</label>
                <select 
              ...
              <div className="flex items-center space-x-6">
                ...
                {Object.keys(filters).length > 0 && (
                  <div className="flex items-center space-x-2">
                    <span className="text-xs text-text-secondary">篩選條件:</span>
                    <div className="flex flex-wrap gap-2">
                      ...
                      {filters.district && (
                        <span className="badge-apple-success">
                          {filters.district}
                        </span>
                      )}
                      {filters.introducer && (
                        <span className="badge-apple-warning">
                          {filters.introducer}
                        </span>
                      )}
                      {filters.project_manager && (
                        <span className="badge-apple-error">
                          {filters.project_manager}
                        </span>
                      )}
                      {filters.search && (
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-bg-tertiary text-text-primary border border-border-light">
                          搜尋: {filters.search}
                        </span>
                      )}
                    </div>
                ...
                {viewMode === 'card' ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {customers.map((customer, index) => (
                      <div
                        key={customer.id}
                        className="card-apple group cursor-pointer transition-all duration-200 hover:shadow-apple-card overflow-hidden"
                        style={{ animationDelay: `${0.4 + index * 0.05}s` }}
                        onClick={() => router.push(`/clients/${customer.customer_id || customer.id}/edit`)}
                      >
                        {/* Enhanced Customer Type Header Bar */}
                        <div className={`px-4 py-3 text-white font-medium text-sm ${
                        ...
                        <div className="card-apple-content">
                          ...
                          <div className="space-y-3 mb-4">
                            ...
                            <div className="flex items-start text-apple-caption text-text-secondary">
                              <svg className="h-4 w-4 mr-3 mt-0.5 text-text-tertiary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <div className="space-y-2 mb-4">
                            <div className="grid grid-cols-2 gap-2">
                              {customer.voucher_application_status && (
                                <div className="text-xs">
                                  <span className="font-medium text-text-primary block mb-1">社區券：</span>
                                  <span className={`px-2 py-1 rounded-full text-xs w-full text-center block ${
                              ...
                              {customer.lds_status && (
                                <div className="text-xs">
                                  <span className="font-medium text-text-primary block mb-1">LDS：</span>
                                  <span className={`px-2 py-1 rounded-full text-xs w-full text-center block ${
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {customer.home_visit_status && (
                                <div className="text-xs">
                                  <span className="font-medium text-text-primary block mb-1">家訪：</span>
                                  <span className={`px-2 py-1 rounded-full text-xs w-full text-center block ${
                              ...
                              {customer.copay_level && (
                                <div className="text-xs">
                                  <span className="font-medium text-text-primary block mb-1">自付：</span>
                                  <span className="px-2 py-1 rounded-full text-xs bg-purple-100 text-purple-800 w-full text-center block">
                                    {customer.copay_level}
                                  </span>
                                </div>
                              )}
                          ...
                          <div className="pt-4 border-t border-border-light text-right">
